...
// index.jsx importa AuthContext y adService (que a su vez importa
// supabase), exigiendo env vars de Supabase al cargar el módulo. No se
// necesita nada de eso para probar isAdminUser() como función pura.
 ...
 * Solo app_metadata.role debe considerarse válido. Esta copia (usada para
 * eximir del límite diario de publicación de fichas de profesional) tenía
 * la misma falla y no había sido cubierta por el fix original.
 */
describe('isAdminUser (post-profesional-form)', () => {
