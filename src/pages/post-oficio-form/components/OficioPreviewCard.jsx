...
export default function OficioPreviewCard({ form, profilePhoto, portfolioPhotos }) {
  ...
  const showPrice = form.priceType === 'from' || form.priceType === 'hourly';

  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
      {/* Header */}
      <div className="p-5 flex items-start gap-4" style={{ background: 'var(--color-primary)', backgroundImage: 'linear-gradient(135deg, var(--color-primary) 60%, rgba(0,0,0,0.15))' }}>
        {/* Avatar */}
        <div className="w-16 h-16 rounded-full border-3 border-white overflow-hidden bg-white/20 flex items-center justify-center shrink-0"
