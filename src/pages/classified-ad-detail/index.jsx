...
export default function ClassifiedAdDetail() {
  ...
  // For oficios: profile photo lives separately; gallery shows only portfolio images.
  // For all other listing types: all images go into the gallery as before.
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-5">
              {/* Image Gallery — for oficios this shows portfolio only, never the profile photo */}
              {images?.length > 0 ? (
