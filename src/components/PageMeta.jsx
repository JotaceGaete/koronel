...
const SITE_NAME = cityConfig.name;
const DEFAULT_DESCRIPTION = `Directorio de negocios y emprendimientos en ${cityConfig.name}, ${cityConfig.region}. Encuentra todo lo local en un solo lugar.`;
